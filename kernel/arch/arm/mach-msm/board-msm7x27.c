...
static char *usb_functions_default[] = {
	...
	"nmea",
	"usb_mass_storage",
	"rmnet",	/*exchange enum sequence with usb mass storage*/
};
...
static struct android_usb_product usb_products[] = {
	{
		.product_id	= 0x9017,	/*ox9026-->0x9017, for the compatibility of our driver*/
		.num_functions	= ARRAY_SIZE(usb_functions_default),
		.functions	= usb_functions_default,
	},
	{
		.product_id	= 0x9018,	/*0x9025-->0x9018, for the compatibility of our driver*/
...
static struct android_usb_platform_data android_usb_pdata = {
	.vendor_id	= 0x05C6,
	.product_id	= 0x9017,	/*0x9026-->0x9017, for the compatibility of our driver*/
	.version	= 0x0100,
...
static struct platform_device msm_device_notify_leds = {
        .name   = "notify-leds",
        .id = -1,
};
...
struct atmel_i2c_platform_data mxt224_ts_data[] = {
{
	...
	.config_T9 = {131, 0, 0, 14, 11, 1, 33, 50, 3, 3, 10, 6, 3, 0x30, 5, 30, 30, 30,0x3f,1,239,0,0, 5, 0, 5, 0x40,0,0,0,18}, // setting [14] to 5 enables 5 pt multitouch, needs to be done for each controller version - netarchy
	.config_T18 = {0, 0},
	.config_T15 = {0x83, 0, 11, 3, 1, 0x01, 32, 38, 3, 0, 0},
...
*/
		...
		rc = gpio_request(0, "ov2659");

		if (!rc) {
			printk("gpio sensor pwd set to 1\n");
...
// }
	...
	if(rv)
		lcdc_panel_device.name = "lcdc_ili9338_rgb";
	else
		lcdc_panel_device.name = "lcdc_ili9341_rgb";
